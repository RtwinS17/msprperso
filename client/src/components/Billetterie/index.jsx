...
const Billets = () => {
    return (
        ...
        <div className='flex flex-col text-white items-center bg-coral bg-opacity-90 md:w-8/12 shadow-lg p-4 rounded-3xl mb-8'>
            <h2 className='text-darkPurple flex pb-4 font-extrabold text-2xl'>Billets</h2>
            <hr className="w-full bg-antiFlashWhite"></hr>
        ...
        <div className='flex flex-col text-white items-center bg-coral bg-opacity-90 md:w-8/12 shadow-lg p-4 rounded-3xl mb-8'>
            <h2 className='text-darkPurple flex pb-4 font-extrabold text-2xl'>Pass VIP</h2>
            <hr className="w-full bg-antiFlashWhite"></hr>
            ...
            <button className='bg-orange text-white text-2xl p-6 rounded-lg hover:bg-darkPurple hover:text-antiFlashWhite font-extrabold'>Acheter des billets</button>
        </div>
    );
}   
