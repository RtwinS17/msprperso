...
const Homemap = () => {
    ...
    return (
      ...
      <div className="bg-cover shadow-lg shadow-darkPurple bg-center h-[350px] w-full flex items-center p-2 rounded-md text-antiFlashWhite bg-coral hover:scale-105 transition transform duration-300"
